...
config.set_section_option(section, "PG_NAME", settings.PG_NAME)
...
config.set_section_option(section, "PG_HOST", settings.PG_LOCALHOST)
...
target_metadata = b.Base.metadata
